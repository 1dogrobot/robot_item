...
def publish_ego_car(ego_car_pub):
    ...
    mesh_marker.mesh_resource = "package://track_one/aaa/Car-Model/Car.dae"  #LOAD ERROR, DON'T KNOW WHY
    ...
    marker_array1.markers.append(mesh_marker)

    ego_car_pub.publish(marker_array1)
